  ...
  <div class="app">
    <div class="container">
      ...
      <nav>
        ...
        <router-link to="/notifications" tag="a" active-class="active">
          <div class="linkBox">
            ...
            <CustomText font="xlarge fw-bold">Notifications</CustomText>
          </div>
        </router-link>
      ...
      <CustomButton class="modalTweetButton">
        <CustomText font="fw-bold">Tweet</CustomText>
      ...
      <div class="user">
        <div class="userBox">
          ...
          <div class="userDetail">
            <CustomText tag="p" font="fw-bold">Mehmet Sağır</CustomText>
            <CustomText tag="p" font="large" class="username"
              >@_memetsagir</CustomText
            >
          </div>
        </div>
