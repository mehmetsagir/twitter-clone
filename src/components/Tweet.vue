      ...
      <div class="tweet">
        ...
        <div class="tweetAction">
          <div>
            ...
            <CustomText class="comment" font="small">{{
              tweet.comments
            }}</CustomText>
          </div>
          <div>
            <icon class="actionHover rt" name="rt" /><CustomText class="rt">{{
              tweet.rt
            }}</CustomText>
          </div>
          <div>
            <icon class="actionHover fav" name="fav" /><CustomText
              class="fav"
              >{{ tweet.fav }}</CustomText
            >
          </div>
      ...
      tweetData: [
        {
          ...
          img: "",
          user: "Mehmet Sağır",
          username: "_memetsagir",
          date: "2h",
          tweetText: "Twitter Clone!",
          comments: "125",
          fav: "964",
          rt: "221"
        },
        ...
        },
        {
          ...
          img: "https://i.morioh.com/2019/12/07/dfe65c53c830.jpg",
          user: "Mustafa",
          username: "mustafa",
          date: "19h",
          tweetText: "Scss / CSS",
  ...
  .tweet {
    ...
    .tweetImage {
      ...
      img {
        ...
        border-radius: 20px;
        border: 1px solid rgba(#38444d, 0.3);
      }
    }
    .tweetAction {
      display: flex;
